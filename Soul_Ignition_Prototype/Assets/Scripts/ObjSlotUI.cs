...
public class ObjSlotUI : MonoBehaviour
{
    ...
    public GameObjectives o_obj; // local reference to Objective in this script
    public GameObjectives Objective { get { return o_obj; } set { o_obj = value; } }
    void Awake()
    {
        ClearObj();
    }

    public void SetObj(GameObjectives obj)
    {
        this.o_obj = obj;
        if (this.o_obj == null)
        {
